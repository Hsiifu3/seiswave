...
class SignalPanel(QWidget):
    ...
    def _setup_ui(self):
        ...
        baseline_form.setLabelAlignment(Qt.AlignRight)
        baseline_form.setFieldGrowthPolicy(QFormLayout.FieldsStayAtSizeHint)
        ...
        self._poly_order_spin.setFixedWidth(120)
        ...
        self._filter_order_spin.setFixedWidth(120)
        ...
        self._f1_spin.setFixedWidth(120)
        ...
        self._f2_spin.setFixedWidth(120)
        ...
        self._orig_plot = PlotWidget(dark=self._dark, show_toolbar=True,
                                     compact_toolbar=True)
        right_splitter.addWidget(self._orig_plot)

        self._proc_plot = PlotWidget(dark=self._dark, show_toolbar=True,
                                     compact_toolbar=True)
    ...
    def _apply_baseline(self):
        ...
        if method_idx == 0:
            ...
            self._processed.acc = Filter.detrend(
                self._processed.acc, self._processed.dt, order=order)
        else:
    ...
    def _apply_filter(self):
        ...
        try:
            ...
            self._processed.acc = Filter.butterworth(
                ...
                ftype=ftype, order=order, freqs=freqs,
            )
            self._plot_processed()
            self.signal_processed.emit(self._processed)
